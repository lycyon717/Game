var DPSMonster = (function (_super) {
    ...
    var d = __define,c=DPSMonster,p=c.prototype;
    p.onMonsterClick = function () { };
    ;
    p.giveReward = function () { };
    ;
    p.attack = function () { };
...
egret.registerClass(DPSMonster,'DPSMonster',["IMonster"]);
var FrogMonster = (function (_super) {
    ...
    var d = __define,c=FrogMonster,p=c.prototype;
    p.findTaskConditionByRule = function () {
        var condition;
...
egret.registerClass(FrogMonster,'FrogMonster');
var DragonMonster = (function (_super) {
    ...
    var d = __define,c=DragonMonster,p=c.prototype;
    p.onMonsterClick = function () {
        if (User.user.locked) {
            return;
        }
...
egret.registerClass(DragonMonster,'DragonMonster');
